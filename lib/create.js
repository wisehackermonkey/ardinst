...
exports.symlik = function (dir_path, library_name) {
...
async function run(library_name) {
    await manager.install(library_name);

    // const moment = manager.require(library_name);
    // console.log(moment().format());

    // await manager.uninstall(library_name);
}
exports.install = async function(name){
  console.log(`${name}`);
  await run(name);
};
