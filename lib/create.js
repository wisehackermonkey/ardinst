...
exports.new_symlink = function(source,description){
...
exports.install = function (name) {
    ...
    let output = execSync(`npm install -g ${name}`);
...
exports.uninstall = function (name) {
    ...
    let output = execSync(`npm uninstall -g ${name}`);
    return output.toString();
};

exports.update = function(library_name,cb){
    console.log(`update libraries`);
    let output = execSync(`npm update -g ${library_name}`);
    return output.toString();
};
